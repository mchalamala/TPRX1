...
Original file is located at
    https://colab.research.google.com/drive/1aD1PyodTlVeQNjqRWf1Gn5aM4RtTLZRK
"""
...
upregulated = df[(df['padj'] < 0.05) & (df['log2FoldChange'] > 2)]
downregulated = df[(df['padj'] < 0.05) & (df['log2FoldChange'] < -2)]
