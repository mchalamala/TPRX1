...
Original file is located at
    https://colab.research.google.com/drive/1XXTDqd0Jb9hq5h2vf-tQY3Ygr33Mr-4q
"""
...
# Add a column for -log10 adjusted p-values
res$log10_padj <- -log10(res$padj)
...
# Create the volcano plot without gene labels
ggplot(res_df, aes(x = log2FoldChange, y = log10_padj, color = color)) +
  geom_point(alpha = 0.7, size = 2) +
  scale_color_manual(values = c("red", "grey", "blue")) +
  labs(title = "Volcano Plot",
...
print("Volcano plot created and saved as 'volcano_plot.png'.")